genuine-polling-v1-closed-loop-combined-fresh-seed-repair
=========================================================
...
independent UDP ON/OFF traffic at 2
...
32 contention STA nodes, according to treatment. The target AP is one logical node using either two independent AP interfaces or one two-link AP MLD.
...
PSDU size. Each treatment uses 30 RNG seeds and is paired by seed.
