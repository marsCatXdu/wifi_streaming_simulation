...
class PairedQualificationPlottingTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        for seed, run_id, arm, latency_us, airtime_us, background_bytes in self.run_specs:
            ...
            frames = [
                {
                    ...
                    "copy_0_completion_us": frame_id + latency_us,
            ...
            if arm == "policy":
                ...
                for frame_id in range(100):
                    if frame_id < 10:
                        ...
                        guard_admitted, launched = 1, 1
                        actionable = 1
                    elif frame_id < 20:
                        status = "airtime_guard_rejected"
                        evaluated, score_passed, guard_considered = 1, 1, 1
                        guard_admitted, launched = 0, 0
                        actionable = 1
                    elif frame_id < 40:
            ...
            manifest_runs.append({"run_id": run_id})
        ...
        manifest_path.write_text(json.dumps({"runs": manifest_runs}), encoding="utf-8")
    ...
    def test_reconstructs_pairs_and_generates_all_outputs(self) -> None:
        rows, report, resolved = paired_rows(self.aggregate_path, self.report_path)
        ...
        diagnostics = policy_admission_diagnostics(resolved, report)
